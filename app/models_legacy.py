...
class CreateBotRequest(BaseModel):
    ...
    video_layout: Literal["speaker_view", "gallery_view_v2", "gallery_view"] = Field(
        default="gallery_view",
    ...
    transcription_language: Optional[str] = Field(
        default=None,
        description="Language code for transcription (e.g., en-US, hi-IN, mr-IN, es-ES). Set to None for auto-detection."
    )
